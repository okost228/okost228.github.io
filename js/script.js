...
const rectanglePlayerElement = document.querySelector(".player");
const rectangle2Element = document.querySelector(".rectangle-right");

createRandomCircles(rectangleElement);
createRandomCircles(rectanglePlayerElement);
createRandomCircles(rectangle2Element);

document.addEventListener("DOMContentLoaded", function () {
  const videoFiles = [
    "content/background/video1.mp4",
    "content/background/video2.mp4",
    "content/background/video3.mp4",
